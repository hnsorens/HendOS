...
EFI_STATUS KERNEL_ExitBootService(preboot_info_t* preboot_info, EFI_HANDLE ImageHandle,
    ...
    Status = SystemTable->BootServices->AllocatePool(
        EfiLoaderData, preboot_info->MemoryMapSize, (void **)&preboot_info->MemoryMap);
...
EFI_STATUS KERNEL_FindMemoryRegions(preboot_info_t* preboot_info, MemoryRegion *regions, size_t regions_count) {
